        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              @else
                  <button href="">Đợi xử lí</button>
              @endif

            </td>
            <td>
                <a href="{{ asset('admin/oder/proc/'.$oder->id)  }}" class="active" ui-toggle-class=""> <i class="fa fa-check text-success text-active"></i></a>
